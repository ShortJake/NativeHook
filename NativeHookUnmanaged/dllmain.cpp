...
void(*ManagedCallback_DebugMethod)(LPVOID animTreePtr, LPVOID skeletonPtr);
const string DebugMethod_Signature = "40 55 57 48 8d ac 24 28 ec ff ff b8 d8 14 00 00";
void(*Original_DebugMethod)(LPVOID, LPVOID, LPVOID, LPVOID);
void Hooked_DebugMethod(LPVOID animTreePtr, LPVOID skeletonPtr, LPVOID param, LPVOID param2)
{
    ManagedCallback_DebugMethod(animTreePtr, skeletonPtr);
    Original_DebugMethod(animTreePtr, skeletonPtr, param, param2);
}
#endif
#pragma endregion
...
#if _DEBUG
    DebugMethod_Address = ScanForFirstResult((LPVOID)NativeDLLAddress, &buffer, DebugMethod_Signature, "DebugMethod");
#endif
    buffer.clear();
}
...
void CreateAllHooks()
{
    ...
    {
        cout << "Error hooking DebugMethod";
    }
#endif
...
void NH_FillCallbacks(LPVOID onPostAiTick, LPVOID onPostAgentTick, LPVOID afterUpdateDynamicsFlags, LPVOID onAnimTreeTick)
{
    ...
    ManagedCallback_OnAnimTreeTick = (void(*)(LPVOID, LPVOID, BYTE, LPVOID))onAnimTreeTick;
}
...
{
    ManagedCallback_DebugMethod = (void(*)(LPVOID, LPVOID))debugMethodCallback;
}
#endif
